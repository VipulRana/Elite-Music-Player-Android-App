...
import com.example.vipul.finalproject.model.Playlist;
...
public class SongList {
     ...
     */
    public ArrayList<PlayListActivity> playlists = new ArrayList<PlayListActivity>();
    ...
    public void scanSongs(Context c, String fromWhere) {
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            PlayListActivity playlist = new PlayListActivity(cursor.getLong(cursor.getColumnIndex(PLAYLIST_ID)),
    ...
    public ArrayList<String> getPlaylistNames() {
        ...
        for (PlayListActivity playlist : playlists)
    ...
    public void newPlaylist(Context c, String fromWhere, String name, ArrayList<Song> songsToAdd) {
        ...
        PlayListActivity newPlaylist = new PlayListActivity(playlistID, name);
