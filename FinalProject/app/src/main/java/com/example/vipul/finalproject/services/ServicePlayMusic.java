package com.example.vipul.finalproject.services;
...
import com.example.vipul.finalproject.*;
import com.example.vipul.finalproject.external.RemoteControlClientCompat;
import com.example.vipul.finalproject.external.RemoteControlHelper;
...
public class ServicePlayMusic extends Service
	 ...
	 */
	private ArrayList<com.example.vipul.finalproject.model.Song> songs;
	 ...
	 */
	public com.example.vipul.finalproject.model.Song currentSong = null;
	 ...
	 */
	public void setList(ArrayList<com.example.vipul.finalproject.model.Song> theSongs) {
		songs = theSongs;
	}
	 ...
	 */
	public void add(com.example.vipul.finalproject.model.Song song) {
		songs.add(song);
	}
	...
	public void updateLockScreenWidget(com.example.vipul.finalproject.model.Song song, int state) {
...
*/
	...
	public void playSong() {
		...
		com.example.vipul.finalproject.model.Song songToPlay = songs.get(currentSongPosition);
	...
	public void sortBy(String rule) {
		...
		// position.
		int position = 0;
		for (com.example.vipul.finalproject.model.Song song : songs) {
	 ...
	 */
	public com.example.vipul.finalproject.model.Song getSong(int position) {
