...
import com.example.vipul.finalproject.activities.ActivityNowPlaying;
...
public class NotificationMusic extends NotificationSimple {
	...
	public void notifySong(Context context, Service service, com.example.vipul.finalproject.model.Song song) {
