package com.example.vipul.finalproject.adapters;
...
public class AdapterSong extends BaseAdapter {
	...
	public AdapterSong(Context c, ArrayList<com.example.vipul.finalproject.model.Song> theSongs) {
		songs = theSongs;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		com.example.vipul.finalproject.model.Song currentSong = songs.get(position);
