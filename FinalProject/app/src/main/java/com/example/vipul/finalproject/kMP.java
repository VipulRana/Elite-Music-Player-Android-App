...
public class kMP {
	 ...
	 */
	public static com.example.vipul.finalproject.services.ServicePlayMusic musicService = null;
	 ...
	 * to display it.
	 */
	public static ArrayList<com.example.vipul.finalproject.model.Song> musicList = null;
	 ...
	 */
	public static ArrayList<com.example.vipul.finalproject.model.Song> nowPlayingList = null;
	...
	public static void startMusicService(Context c) {
		...
		// the MusicService.
		musicServiceIntent = new Intent(c, com.example.vipul.finalproject.services.ServicePlayMusic.class);
	...
	public static void forceExit(Activity c) {
		...
		Intent intent = new Intent(c, com.example.vipul.finalproject.activities.ActivityQuit.class);
